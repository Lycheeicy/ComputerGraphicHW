...
\item The program should stop with segmentation fault exception. Type list to
  ...
  crashing?\\*[1em]
  \TODO
\item Use the command \CM{print <statement>} with the variables that are
  being accessed on the line where the program is crashing. You can use the \CM{up} command to go back a line if needed. Why does the program
